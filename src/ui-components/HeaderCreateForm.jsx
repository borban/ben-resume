...
import { createHeader } from "../graphql/mutations";
const client = generateClient();
export default function HeaderCreateForm(props) {
  const {
    clearOnSuccess = true,
    onSuccess,
    onError,
  ...
  const resetStateValues = () => {
    ...
    setCustom_url1(initialValues.custom_url1);
    setCustom_url2(initialValues.custom_url2);
    setCustom_url3(initialValues.custom_url3);
  ...
  return (
    <Grid
      ...
      onSubmit={async (event) => {
        ...
        try {
          ...
          await client.graphql({
            query: createHeader.replaceAll("__typename", ""),
            variables: {
              input: {
                ...modelFields,
              },
      ...
      {...getOverrideProps(overrides, "HeaderCreateForm")}
      {...rest}
    >
      <TextField
        label="Title"
